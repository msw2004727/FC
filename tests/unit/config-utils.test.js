...
describe('Sport Config Lookup', () => {
  ...
  describe('getSportIconSvg', () => {
    test('returns image markup for football tag', () => {
      const result = getSportIconSvg('football');
      expect(result).toContain('<img');
      expect(result).toContain('img/Socce.png');
    ...
    test('defaults to football image for invalid key', () => {
      const result = getSportIconSvg('invalid');
      expect(result).toContain('img/Socce.png');
      expect(result).toContain('sport-emoji');
    });

    test('defaults to football image for null/undefined', () => {
    ...
    test('no extra space in class when className is empty', () => {
      const result = getSportIconSvg('football', '');
      expect(result).toContain('class="sport-emoji"');
      expect(result).not.toContain('sport-emoji ');
      expect(result).toContain('img/Socce.png');
    });
...
describe('Permission System', () => {
  ...
  describe('getInherentRolePermissions', () => {
    ...
    test('super_admin has INHERENT admin.repair.event_blocklist + admin.seo.entry', () => {
      // super_admin is INHERENT for event blocklist and SEO dashboard
