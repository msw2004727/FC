  ...
  test("scoreboardConfig accepts schemaVersion 2 SportsAPI Pro catalog fields", async () => {
    ...
    await assertSucceeds(
      setDoc(doc(contentManager(), "siteConfig", "scoreboardConfig"), {
        ...
        homepageOrder: [...allSportsApiProSports, "nba"],
        defaultSportTabs: allSportsApiProSports,
        enabledSports: allSportsApiProSports,
        homepageSports: allSportsApiProSports,
        liveSports: allSportsApiProSports,
        scheduleSports: allSportsApiProSports,
        detailSports: allSportsApiProSports,
        sportsOrder: allSportsApiProSports,
