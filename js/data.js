...
const DemoData = {
  ...
  achievements: [
    { name: '初心者', icon: '初', unlocked: true },
    { name: '全勤之星', icon: '勤', unlocked: true },
    { name: '鐵人精神', icon: '鐵', unlocked: true },
    { name: '社交蝴蝶', icon: '社', unlocked: true },
    { name: '冠軍', icon: '冠', unlocked: false },
    { name: 'MVP', icon: 'M', unlocked: false },
    { name: '百場達人', icon: '百', unlocked: false },
    { name: '傳奇球員', icon: '傳', unlocked: false },
  ],

  badges: [
    { name: '足球達人', icon: '足' }, { name: '守門員', icon: '守' },
    { name: '前鋒王', icon: '鋒' }, { name: '助攻王', icon: '助' },
    { name: '最佳隊友', icon: '友' }, { name: '鐵腿王', icon: '腿' },
  ],
