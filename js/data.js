...
const DemoData = {
  ...
  events: [
    ...
    // ── 2月（已結束） ──
    { id: 'e0a', title: '冬季足球體能活動', type: 'play', status: 'ended', location: '台北市大安運動中心', date: '2026/02/22 08:00~12:00', fee: 0, max: 30, current: 28, waitlist: 0, waitlistMax: 0, creator: '教練阿豪', contact: '0922-111-222', gradient: 'linear-gradient(135deg,#7c3aed,#4338ca)', icon: '', countdown: '已結束', participants: ['王小明','李大華','張三','陳美玲','林志偉','黃小琳','吳宗翰','鄭家豪'], waitlistNames: [] },
    ...
    { id: 'e14', title: '春季足球體能活動', type: 'play', status: 'upcoming', location: '高雄市三民體育館', date: '2026/04/15 08:00~12:00', fee: 0, max: 30, current: 0, waitlist: 0, waitlistMax: 0, creator: '教練阿豪', contact: '0922-111-222', gradient: 'linear-gradient(135deg,#7c3aed,#4338ca)', icon: '', countdown: '33天 0時', participants: [], waitlistNames: [] },
    { id: 'e15', title: '新春PLAY八強賽', type: 'play', status: 'upcoming', location: '台中市豐原體育場', date: '2026/04/19 13:00~17:00', fee: 0, max: 16, current: 0, waitlist: 0, waitlistMax: 0, creator: '管理員', contact: '', gradient: 'linear-gradient(135deg,#7c3aed,#4338ca)', icon: '', countdown: '37天 4時', participants: [], waitlistNames: [] },
    ...
    { id: 'e17', title: '春季PLAY第五輪', type: 'play', status: 'upcoming', location: '台北市大安運動中心', date: '2026/04/26 14:00~18:00', fee: 0, max: 22, current: 0, waitlist: 0, waitlistMax: 0, creator: '管理員', contact: '', gradient: 'linear-gradient(135deg,#7c3aed,#4338ca)', icon: '', countdown: '44天 5時', participants: [], waitlistNames: [] },
  ],
  ...
  teams: [
    { id: 'tm1', name: '雷霆隊', nameEn: 'Thunder FC', emblem: '雷', captain: '隊長A', coaches: ['教練B','教練C'], members: 18, color: '#3b82f6', region: '台北市', active: true, pinned: true, pinOrder: 1, wins: 12, draws: 3, losses: 2, gf: 35, ga: 15, bio: '雷霆隊成立於 2024 年，以快速反擊與團隊默契著稱。\n球隊宗旨：享受足球、追求卓越。\n\n歡迎對足球有熱忱的夥伴加入，一起在場上揮灑汗水！', history: [{name:'2026春季聯賽',result:'進行中 — 第1名'},{name:'2025秋季聯賽',result:'冠軍'},{name:'新春盃淘汰賽',result:'四強'}] },
    { id: 'tm2', name: '閃電隊', nameEn: 'Lightning FC', emblem: '電', captain: '隊長D', coaches: ['教練E'], members: 15, color: '#eab308', region: '台中市', active: true, pinned: true, pinOrder: 2, wins: 9, draws: 4, losses: 4, gf: 28, ga: 20, bio: '閃電隊來自台中，擅長控球與中場組織。\n我們重視紀律與團隊合作，定期舉辦隊內訓練與友誼賽。', history: [{name:'2026春季聯賽',result:'進行中 — 第2名'},{name:'2025秋季聯賽',result:'季軍'}] },
    { id: 'tm3', name: '旋風隊', nameEn: 'Cyclone FC', emblem: '旋', captain: '隊長F', coaches: [], members: 12, color: '#10b981', region: '高雄市', active: true, pinned: true, pinOrder: 3, wins: 7, draws: 5, losses: 5, gf: 22, ga: 21, bio: '南部最具活力的業餘球隊！\n每週六固定練球，歡迎高雄地區球友加入。', history: [{name:'2026春季聯賽',result:'進行中 — 第3名'},{name:'新春盃淘汰賽',result:'八強'}] },
    { id: 'tm4', name: '火焰隊', nameEn: 'Blaze FC', emblem: '火', captain: '隊長G', coaches: ['教練H'], members: 20, color: '#ef4444', region: '台北市', active: true, pinned: true, pinOrder: 4, wins: 6, draws: 3, losses: 8, gf: 20, ga: 28, bio: '火焰隊以熱血聞名，永不放棄是我們的精神。\n2025 秋季聯賽亞軍，目標挑戰冠軍寶座！', history: [{name:'2026春季聯賽',result:'進行中 — 第4名'},{name:'2025秋季聯賽',result:'亞軍'}] },
  ...
  sponsors: [
    ...
    { id: 'sp7',  slot: 7,  title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp8',  slot: 8,  title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp9',  slot: 9,  title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp10', slot: 10, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp11', slot: 11, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp12', slot: 12, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp13', slot: 13, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp14', slot: 14, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp15', slot: 15, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp16', slot: 16, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp17', slot: 17, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp18', slot: 18, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp19', slot: 19, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp20', slot: 20, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp21', slot: 21, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp22', slot: 22, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp23', slot: 23, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
    { id: 'sp24', slot: 24, title: '', image: null, status: 'empty', linkUrl: '', publishAt: null, unpublishAt: null, clicks: 0 },
  ],
