...
const ScriptLoader = {
  ...
  _groups: {
    ...
    activity: [
      ...
      'js/modules/event-share-builders.js',
      'js/modules/event-share.js',
      'js/modules/event-detail-reviews.js',
      'js/modules/event-detail.js',
      'js/modules/event-detail-signup.js',
      'js/modules/event-detail-companion.js',
      'js/modules/event-create-input-history.js',
      'js/modules/event-create-sport-picker.js',
      'js/modules/event-create-delegates.js',
      'js/modules/event-create-options.js',
      'js/modules/event-create-team-picker.js',
      'js/modules/event-create-external.js',
      'js/modules/event-create-template.js',
      'js/modules/event-create-waitlist.js',
      'js/modules/event-create.js',
      'js/modules/event-manage-noshow.js',
      'js/modules/event-manage-attendance.js',
      'js/modules/event-manage-confirm.js',
      'js/modules/event-manage-lifecycle.js',
      'js/modules/event-manage-badges.js',
      'js/modules/event-manage-waitlist.js',
    ...
    team: [
      ...
      'js/modules/team-form-join.js',
      'js/modules/team-form-search.js',
      'js/modules/team-form-init.js',
    ...
    tournamentAdmin: [
      'js/modules/event-share-builders.js',
      'js/modules/event-share.js',
      'js/modules/tournament-manage-form.js',
      'js/modules/tournament-manage-host.js',
      'js/modules/tournament-manage-edit.js',
