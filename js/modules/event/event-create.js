  ...
  _ceInfoData: {
    ...
    teamSplit: {
      ...
      body: '開啟後系統會在報名流程中加入<b>隊伍分配機制</b>，讓參加者到場前就知道自己穿什麼顏色背心。'
        ...
        + '<div style="margin:.6rem 0 .3rem;padding:.55rem .7rem;border:1.5px solid var(--accent);border-radius:8px;background:rgba(13,148,136,.06)">'
        ...
        + '<div style="font-size:.75rem;color:var(--text-secondary);padding:.35rem .5rem;background:var(--bg-elevated);border-radius:6px;margin-bottom:.25rem">'
        + '• 20 人活動 ÷ 2 隊 → 每隊上限 <b>10 人</b><br>'
        + '• 20 人活動 ÷ 3 隊 → 每隊上限 <b>7 人</b>（20÷3=6.67 進位）<br>'
        + '• 15 人活動 ÷ 4 隊 → 每隊上限 <b>4 人</b>（15÷4=3.75 進位）</div>'
