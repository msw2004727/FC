...
Object.assign(App, {
  ...
  _PERM_INFO: {
    ...
    'admin.repair.event_blocklist': {
      title: '活動黑名單',
      body: '允許將特定用戶加入活動黑名單，使其看不到該活動（僅擋尚未報名的，已報名的保留可見以尊重歷史）。<br>適用於處理反覆放鴿子、違規報名等需要個別限制的情境。<br>僅擋用戶端顯示，所有操作皆記錄審計軌跡（誰加的、何時、原因）。',
    },
    'activity.view_noshow': {
      title: '查看放鴿子次數',
      body: '允許在活動報名名單（詳情頁）看到每位參與者的歷史放鴿子累積次數（🕊 欄位）。<br>預設：教練、幹部、管理員、超級管理員可見；一般用戶不可見。<br>活動主辦人與委託人不論角色皆自動可見自己的活動。<br>不影響「放鴿子修改」權限（獨立權限碼 admin.repair.no_show_adjust）。',
    },
    ...
    'admin.banners.entry': {
      title: '首頁管理',
      body: '允許進入首頁管理功能區，可管理首頁輪播、排版順序、浮動廣告、贊助廣告與品牌開機畫面。',
    },
