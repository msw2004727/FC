...
Object.assign(App, {
  renderUserCard() {
    ...
    container.innerHTML = `
      ...
      <div class="info-card">
        ...
        <div class="info-row"><span>所屬俱樂部</span><span class="uc-team-list">${teamHtml}</span></div>
  ...
  _qrFallbackImg(container, data, size) {
    ...
    img.src = `https://api.qrserver.com/v1/create-qr-code/?size=${size}x${size}&ecc=M&margin=7&data=${encodeURIComponent(data)}`;
    img.width = size;
    img.height = size;
    img.alt = 'QR Code';
  ...
  _socialPlatforms: {
    ...
    line:    { name: 'LINE',        prefix: 'https://line.me/ti/p/' },
  },
