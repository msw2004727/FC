/* Legacy path shim.
   ...
   that requests js/modules/auto-exp-rules.js. */
(function () {
  if (typeof App !== 'undefined' && typeof App._reconcileAutoExp === 'function') return;
  ...
  try {
    loadReplacement('js/modules/auto-exp/rules.js');
  } catch (err) {
    console.error('[legacy-auto-exp-rules] failed:', err);
  }
})();
