...
- `admin`
- `super_admin`
- 擁有至少一支俱樂部，且在該俱樂部是 `captain` 或 `leader` 的一般使用者
...
- 若未來要切換成主辦俱樂部代表人，需另開規格，不在 v1 內變更

## 可見性矩陣
### 主辦俱樂部 captain/leader
...
### 申請俱樂部成員
- 可見自己俱樂部的 application 狀態
- 可見全部公開 entries
- 不可見其他俱樂部的 pending / rejected application
