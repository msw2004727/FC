...
1. 使用者進入賽事詳情頁
2. 點擊 `參加賽事`
3. 系統檢查此人是否為任一俱樂部的 `captain / leader`
4. 若只有一支可申請俱樂部：
   - 直接送出申請
5. 若有多支可申請俱樂部：
   - 彈出選隊 modal
6. 系統建立 `applications/{applicationId}`
7. 詳情頁對主辦與申請俱樂部顯示灰色 pending 列
8. 第三方仍看不到此申請
...
## Flow D：已核准俱樂部的隊員加入
1. 一般隊員進入詳情頁
2. 系統檢查其所屬俱樂部中，哪些已存在 `approved entry`
3. 若沒有：
   - 按鈕反灰
   - 點擊提示需先由俱樂部負責人報名並經主辦核准
4. 若有一支：
   - 直接加入該隊 member 子集合
5. 若有多支：
   - 先跳出選隊 modal
