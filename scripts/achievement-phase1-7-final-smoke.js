...
async function main() {
  ...
  const achievements = [
    ...
    { id: 'a-join', name: '俱樂部新人', category: 'gold', badgeId: 'b-join', current: 0, completedAt: null, status: 'active', condition: { timeRange: 'none', action: 'join_team', filter: 'all', threshold: 1 } },
  ...
  const badges = [
    ...
    { id: 'b-join', name: '俱樂部新人徽章', achId: 'a-join', category: 'gold', image: null },
